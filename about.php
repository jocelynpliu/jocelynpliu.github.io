...
<body>
    <?php include 'nav.php' ?>
    <div class="container my-5 about-me">
        <div class="img-div">
                <img class="main-img" alt="baby" src="assets/babyme.png">
                <div class="sub-img-div"></div>
        </div>
        <p>
            Hi there! My name is Jocelyn Liu. I am finishing up my 3rd year in the <b>Computer Science program</b> at USC.
            <br> <br>
